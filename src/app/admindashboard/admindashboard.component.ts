...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, MatIconModule, MatGridListModule, MatFormFieldModule, MatInputModule, MatTableModule, MatSortModule, NgIf, MatButtonModule, MatPaginatorModule]
})
